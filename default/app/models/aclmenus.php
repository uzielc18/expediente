...
//    public $logger = true;
    ...
    public function menus_paginados($pagina,$visible=3) {
        ...
        return $this->paginate("conditions: aclmenus.visible_en='".$visible."'","page: $pagina", "per_page: 20", "columns: $cols","join: $joins",'order: aclmenus.posicion,aclmenus.aclmenus_id');
    }
